...
class Parameter {
   ...
   */
  updateValue(value: any, timestamp: Date = new Date()): void {
   ...
   */
  recordWrite(timestamp: Date = new Date()): void {
   ...
   * Record error
   */
  recordError(error: Error | string, timestamp: Date = new Date()): void {
    this.lastError = {
