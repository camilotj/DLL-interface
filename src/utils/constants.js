...
// Human-readable return code descriptions
const RETURN_CODE_MESSAGES = {
...
// Parameter definitions for standard IO-Link parameters
...
const VENDOR_IDS = {
  ...
  0x000a: "Vendor_A", // For HBK/Hottinger devices
  0x0010: "FESTO",
  0x0011: "Siemens",
...
const LIMITS = {
  ...
  CACHE_TTL_PROCESS_DATA: 1000, // 1 second
  CACHE_TTL_PARAMETERS: 30000, // 30 seconds
  STREAM_INTERVAL_MIN: 100, // 100ms minimum streaming interval
  STREAM_INTERVAL_DEFAULT: 1000, // 1 second default streaming interval
  STREAM_INTERVAL_MAX: 60000, // 1 minute maximum streaming interval
};
