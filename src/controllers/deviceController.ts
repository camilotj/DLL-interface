 ...
 */
export const discoverMasters = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getConnectedMasters = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const connectMaster = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const disconnectMaster = asyncHandler(async (req: Request, res: Response) => {
 ...
 */
export const getDeviceInfo = asyncHandler(async (req: Request, res: Response) => {
  const { masterHandle, deviceId } = req.params;
  const handle = parseInt(masterHandle);
  const port = parseInt(deviceId);
 ...
 */
export const getDeviceSummary = asyncHandler(async (req: Request, res: Response) => {
  ...
  const devicesByVendor = devices.reduce((acc: Record<string, any[]>, device) => {
  ...
  const devicesByState = devices.reduce((acc: Record<string, number>, device) => {
...
export const getSystemHealth = asyncHandler(async (req: Request, res: Response) => {
  ...
  const deviceUptimes = connectedDevices.map((device) => ({
    ...
    uptime: device.connectedAt ? now.getTime() - new Date(device.connectedAt).getTime() : 0,
